...
const Admin = {
  // ── Auth ─────────────────────────────────────────────────
  // Nota: La verificación de auth ahora la maneja shared.js via JWT/API.
  // Este método se mantiene por compatibilidad con páginas que lo llamen.
  requireAuth() {
    // No-op: shared.js maneja requireAuth con JWT
  },

  login(e) {
    // No-op: login.html maneja el login con la API directamente
